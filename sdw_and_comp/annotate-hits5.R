...
out_dir <- "/mmfs1/projects/barney.geddes/tania.gupta/TG_comparitive_genomics/whole_genome/A_renamed_whole_genome_prokka_roary_results/roary_output_whole_renamned/85/scoary2_changed_script/scoary2_sdw_mean/gene_mapping"
